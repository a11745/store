		...
		<div class="container">
			...
			<div style="margin-right:130px;">
				...
				<div style="text-align:right;margin-top:10px;margin-bottom:10px;">
					<a href="javascript:void(0)" id="clear" class="clear" onclick="clearAll()">清空购物车</a>
...
<script>
	function removeFromCart(pid){
		if(confirm("你确定删除此商品么")){
			location.href="${pageContext.request.contextPath}/cart?method=remove&pid="+pid;
		}
	}
	function clearAll(){
		if(confirm("你确定删除此商品么")){
			location.href="${pageContext.request.contextPath}/cart?method=clearAll";
		}
	}
</script>
</html>